...
All other props are forwarded to the underlying Radix primitive's inner `<div>`.
...
- DO use `ratio` to pick a semantic aspect. DON'T pass arbitrary `className` to override dimensions.
