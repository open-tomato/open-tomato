        ...
        patterns: [
          {
            ...
            message: 'Banned source package — use local relative imports inside @open-tomato/ui-portal.',
          },
          {
            group: [`*${BANNED_SOURCE_REPO}*`],
            message: 'Cross-repo path imports are banned in @open-tomato/ui-portal.',
          },
        ],
      }],
    },
