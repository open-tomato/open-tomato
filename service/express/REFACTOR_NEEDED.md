# REFACTOR_NEEDED — @open-tomato/express
...
- [ ] No README.
- [ ] Depends on `@open-tomato/service-core` (internal, also private).
- [ ] Large transitive dep footprint (express, helmet, cors, rate-limit) — confirm intentional.
