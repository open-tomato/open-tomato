# REFACTOR_NEEDED — @open-tomato/mcp
...
- [ ] No README.
- [ ] Depends on `@open-tomato/logger` and `@open-tomato/service-core` (both internal and private).
- [ ] `@modelcontextprotocol/sdk` appears as peer dep + dep + devDep — clean up before graduation.
