# REFACTOR_NEEDED — @open-tomato/prompt-builder
...
- [ ] No README.
- [ ] Depends on `@open-tomato/types` (internal, also private).
- [ ] `gpt-tokenizer` dep ships large WASM — confirm tarball size acceptable.
