# REFACTOR_NEEDED — @open-tomato/eslint-config
...
- [ ] Awaiting Wave 2 graduation PR (see design spec). Needs README covering `/`, `/next`, `/react` entries; `files` whitelist; graduation changeset.
