...
const STORAGE_KEY = 'open-tomato.homepage.theme';

/** Light is the marketing default; the header toggle flips it. Stamped as
 *  `data-theme` on <html> per the theme-default tokens.css contract. */
